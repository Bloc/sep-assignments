...
RSpec.describe HashClass, type: Class do
  ...
  describe "hash[key] = value" do
    ...
    it "sets the value of key to value" do
      ...
      lotr_movies["The Hobbit: The Battle of Five Armies, Final Cut"] = "2 hours, 44 minutes"
      ...
      expect(lotr_movies["The Hobbit: The Battle of Five Armies, Final Cut"]).to eq "2 hours, 44 minutes"
    end
  end
end
